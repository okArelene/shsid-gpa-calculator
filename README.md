...
- **UC capped maximum:** 4.333 is the highest complete Grade 10–11 combination derivable from the local SHSID catalog: 24 counted A–G semester grades with all 8 honors points. The maximizing Grade 11 schedule is “one science + one elective” with Computer Skills excluded automatically as non-A–G.
